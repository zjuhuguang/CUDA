...
int main(int argc, char* argv[])
{
    ...
    TIME_IT("opt_2dhisto",
            1000,
            opt_2dhisto(D_input, INPUT_HEIGHT, INPUT_WIDTH, g_bins, D_bins);)
    ...
    CopyFromDevice(g32_bins, g_bins, HISTO_HEIGHT * HISTO_WIDTH * sizeof(uint32_t));		
    FreeDevice(D_bins);
    FreeDevice(D_input);
    ...
    FILE *p2 = fopen("out2.txt", "w");
    FILE *p3 = fopen("out3.txt", "w");
